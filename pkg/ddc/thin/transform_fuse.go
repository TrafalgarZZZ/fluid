...
func (t *ThinEngine) transformFuse(runtime *datav1alpha1.ThinRuntime, profile *datav1alpha1.ThinRuntimeProfile, dataset *datav1alpha1.Dataset, value *ThinValue) (err error) {
	...
	// 2. resources
	t.Log.Info("transformResourcesForFuse() with runtime", "runtime", fmt.Sprintf("%s/%s", runtime.GetNamespace(), runtime.GetName()), "runtime resource", runtime.Spec.Fuse.Resources, "value resource", value.Fuse.Resources)
...
func (t *ThinEngine) parseFromProfileFuse(profile *datav1alpha1.ThinRuntimeProfile, value *ThinValue) {
	...
	// 2. resources
	t.Log.Info("transformResourcesForFuse() with runtime profile", "profile", profile.Name, "profile resource", profile.Spec.Fuse.Resources, "value resource", value.Fuse.Resources)
